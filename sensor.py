...
def writevalue(myworkfile,litre):
  #      print "writevalue callback" + str(litre)
	f = open(myworkfile, 'w')
        f.write((str(litre)+ '\n'))                     # the value
...
#	print "my_callback" + str(litre)
	...
	if counter == 66:
		...
		counter += 1
    	return litre, counter

def send2emon():
	try:
		params = ("{" + "Water(Lt)" + ":"  + str(litre) + "," + "Temp(C)" + ":"  + str(bmp180_temp) + "," + "Pressure(Pa)" + ":"  + str(bmp180_pressure) + "}" )
...
#	print('Pressure = {0:0.2f} mbar'.format(sensor.read_pressure()/100))
#	print "while true" + str(litre)
	bmp180_temp = sensor.read_temperature()
	bmp180_pressure = sensor.read_pressure()
	
	send2emon()
#        params = ("{" + "Litres" + ":"  + str(litre) + "," + "Temp" + ":"  + str(bmp180_temp) + "," + "Pressure" + ":"  + str(bmp180_pressure) + "}" )
#        print params
